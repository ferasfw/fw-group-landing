          ...
          <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center items-start bg-white">
            ...
            <div className="flex items-end mb-6 relative">
              ...
              <div className="relative ml-8 md:ml-10">
                ...
                <span className="absolute top-full left-1/2 -translate-x-1/2 mt-2 text-[10px] md:text-[11px] font-bold tracking-widest uppercase text-gray-400 text-center whitespace-nowrap">
                  Click to Visit
                </span>
              </div>
            </div>
