  ...
  return (
    <div className="bg-white text-black antialiased selection:bg-black selection:text-white font-sans">
      ...
      <header className="w-full flex flex-col items-center justify-center px-6 py-16 md:py-24 border-b border-black text-center">
        ...
        <h1 className="text-[15vw] md:text-[14rem] leading-none font-black tracking-tighter uppercase text-black mb-2">
          FW Group
        </h1>
        {/* Subheader with wide tracking */}
        <span className="text-xl md:text-4xl font-bold tracking-[0.4em] md:tracking-[0.6em] uppercase text-black mb-16">
          Global Media Agency
        </span>
        
        <h2 className="text-2xl md:text-5xl font-black text-black mb-16 tracking-tight max-w-5xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <span className="text-3xl md:text-5xl font-black text-black tracking-[0.2em] uppercase">
            Followers
          </span>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto">
        ...
        <section className="flex flex-col md:flex-row items-stretch min-h-[75vh] border-b border-black">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-white">
            ...
            <div className="flex items-center flex-wrap gap-4 mb-2">
              <h2 className="text-4xl md:text-6xl font-black tracking-tight text-black">Rula Al-Hroub</h2>
              <div className="flex flex-col items-center justify-center mt-2 md:mt-0">
                ...
                <span className="text-[10px] font-bold tracking-widest uppercase mt-1 text-gray-500">Click to Visit</span>
              </div>
            </div>
        ...
        <section className="flex flex-col md:flex-row-reverse items-stretch min-h-[75vh] border-b border-black">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-white">
            ...
            <div className="flex items-center flex-wrap gap-4 mb-2">
              <h2 className="text-4xl md:text-6xl font-black tracking-tight text-black">Mira / Ephey</h2>
              <div className="flex flex-col items-center justify-center mt-2 md:mt-0">
                <a 
      ...
      {/* Footer Section */}
      <footer className="py-16 px-6 text-center text-xs md:text-sm tracking-widest text-black font-black uppercase">
