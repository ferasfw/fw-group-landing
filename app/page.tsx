...
export default function Home() {
  return (
    <div className="bg-white text-black antialiased selection:bg-black selection:text-white font-sans">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center items-start bg-white">
            ...
            <div className="flex items-end mb-10 relative">
              ...
              <div className="relative ml-[5px]">
                ...
                <span className="absolute top-full left-1/2 -translate-x-1/2 mt-2 text-[12px] font-black tracking-widest uppercase text-white bg-black px-2 py-1 text-center whitespace-nowrap">
                  Click to Visit
                </span>
              </div>
            </div>
      ...
      {/* Footer Section */}
      <footer className="py-16 px-6 flex flex-row items-end justify-center gap-[50px] text-xs md:text-sm tracking-widest text-black font-black uppercase">
        <a href="mailto:feras@thefwgroup.co" className="flex items-end hover:underline transition-all duration-300">
          <svg className="w-5 h-5 mr-2 mb-[2px]" fill="currentColor" viewBox="0 0 20 20">
        ...
        <a href="https://www.linkedin.com/in/ferasalhroub/" target="_blank" rel="noopener noreferrer" className="flex items-end hover:underline transition-all duration-300">
          <svg className="w-5 h-5 mr-2 mb-[2px]" fill="currentColor" viewBox="0 0 24 24">
